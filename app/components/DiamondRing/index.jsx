export default function DiamondRing() {
  return (
    <div className="diamond-ring fixed top-[40%] md:top-[50%] right-[50%] md:right-[20%] translate-x-[-50%] translate-y-[-50%] z-[999]">
